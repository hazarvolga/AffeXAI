...
let CreateCertificateDto = (() => {
    ...
    return class CreateCertificateDto {
        static {
            ...
            _recipientName_decorators = [(0, class_validator_1.IsString)()];
            _recipientEmail_decorators = [(0, class_validator_1.IsEmail)()];
            _trainingTitle_decorators = [(0, class_validator_1.IsString)()];
            ...
            _signatureUrl_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _imageUrl_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _issuedAt_decorators = [(0, class_validator_1.IsDateString)(), (0, class_validator_1.IsOptional)()];
            _validUntil_decorators = [(0, class_validator_1.IsDateString)(), (0, class_validator_1.IsOptional)()];
            _status_decorators = [(0, class_validator_1.IsEnum)(certificate_entity_1.CertificateStatus), (0, class_validator_1.IsOptional)()];
            _userId_decorators = [(0, class_validator_1.IsUUID)(), (0, class_validator_1.IsOptional)()];
            _eventId_decorators = [(0, class_validator_1.IsUUID)(), (0, class_validator_1.IsOptional)()];
            _name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _issueDate_decorators = [(0, class_validator_1.IsDateString)(), (0, class_validator_1.IsOptional)()];
        ...
        recipientName = __runInitializers(this, _recipientName_initializers, void 0);
        ...
        // Dates
        issuedAt = (__runInitializers(this, _imageUrl_extraInitializers), __runInitializers(this, _issuedAt_initializers, void 0));
        validUntil = (__runInitializers(this, _issuedAt_extraInitializers), __runInitializers(this, _validUntil_initializers, void 0));
        // Status
        status = (__runInitializers(this, _validUntil_extraInitializers), __runInitializers(this, _status_initializers, void 0));
        // Relations
        userId = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
        eventId = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _eventId_initializers, void 0));
        // Backward compatibility
        name = (__runInitializers(this, _eventId_extraInitializers), __runInitializers(this, _name_initializers, void 0));
        issueDate = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _issueDate_initializers, void 0));
