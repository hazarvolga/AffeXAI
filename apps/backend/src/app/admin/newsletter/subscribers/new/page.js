...
exports.default = NewSubscriberPage;
...
function NewSubscriberPage() {
    const [subscriber, setSubscriber] = (0, react_1.useState)({
        email: '',
        firstName: '',
        lastName: '',
        company: '',
    ...
    const validateEmail = async (email) => {
        ...
        try {
            ...
            const result = await emailValidationService_1.default.validateEmail(email, undefined);
    ...
    const handleSave = async () => {
        try {
            setSaving(true);
            await subscribersService_1.default.createSubscriber({
    ...
    return (<div className="space-y-8">
      ...
      <card_1.Card>
        <card_1.CardHeader>
          ...
          <card_1.CardDescription>Abonenin iletişim ve profil bilgilerini girin.</card_1.CardDescription>
        </card_1.CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <input_1.Input id="email" type="email" value={subscriber.email} onChange={(e) => handleEmailChange(e.target.value)} className="flex-1 pr-10" placeholder="E-posta adresi"/>
              ...
              {emailValidationResult && (<div className="space-y-1">
                  ...
                  {emailValidationResult.checks?.ipReputation && (<p className="text-sm text-muted-foreground">
                  ...
                  {emailValidationResult.checks?.domainReputation && (<p className="text-sm text-muted-foreground">
        ...
        <card_1.CardFooter className="flex justify-end gap-2">
          ...
          <button_1.Button onClick={handleSave} disabled={saving || !subscriber.email}>
