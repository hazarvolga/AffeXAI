...
export const FooterBasic: React.FC<any> = (props) => {
  ...
  const validatedLinks = links.map((linkSection: any) => ({
    ...linkSection,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {validatedLinks.map((linkSection: any, sectionIndex: number) => (
...
export const FooterMultiColumn: React.FC<any> = (props) => {
  ...
  const validatedColumns = columns.map((column: any) => ({
    ...column,
      ...
      >
        <div className="col-span-2">
          ...
          <TextComponent 
            ...
            align={companyDescriptionAlign}
            color={companyDescriptionColor}
            weight={companyDescriptionWeight}
        ...
        {validatedColumns.map((column: any, columnIndex: number) => (
      ...
      >
        <div>
          <TextComponent 
            ...
            variant={newsletterTitleVariant}
            align={newsletterTitleAlign}
            color={newsletterTitleColor}
            weight={newsletterTitleWeight}
            className="mb-2" 
          />
          <TextComponent 
            id="footer-newsletter-desc"
            content={newsletterDescription}
            variant={newsletterDescriptionVariant}
            align={newsletterDescriptionAlign}
            color={newsletterDescriptionColor}
            weight={newsletterDescriptionWeight}
            className="text-muted-foreground" 
          />
        </div>
        <div className="flex">
      ...
      >
        ...
        <div className="col-span-2">
          <TextComponent 
            ...
            content={socialTitle}
            variant={socialTitleVariant}
            align={socialTitleAlign}
            color={socialTitleColor}
            weight={socialTitleWeight}
            className="mb-6" 
          />
          <GridComponent 
    ...
    >
      ...
      >
        <TextComponent 
          ...
          content={ctaTitle}
          variant={ctaTitleVariant}
          align={ctaTitleAlign}
          color={ctaTitleColor}
          weight={ctaTitleWeight}
          className="mb-4" 
        />
        <TextComponent 
          id="footer-extended-cta-desc"
          content={ctaDescription}
          variant={ctaDescriptionVariant}
          align={ctaDescriptionAlign}
          color={ctaDescriptionColor}
          weight={ctaDescriptionWeight}
