...
import { Code, FileCode, Layers, Database, Bot, Share2, Palette, ShieldCheck, Send, Settings, AlertCircle, Award, LayoutDashboard, Mail, FileText } from "lucide-react";
...
export default function BlueprintPage() {
    return (
        <div>
            ...
            <Card className="mt-6">
                 <CardHeader>
                    <CardTitle>Proje Yapısı JSON</CardTitle>
                    <CardDescription>Projenin tüm sayfaları, bileşenleri, rolleri ve veri kaynaklarını içeren makine tarafından okunabilir JSON çıktısı.</CardDescription>
                </CardHeader>
                <CardContent>
                    <CodeBlock>
{`
{
  "pages": [
    {
      ...
      "interactiveElements": [
        ...
        { "id": "viewAllCampaigns", "type": "button", "action": "/admin/email-marketing sayfasına yönlendirir." },
    ...
    },
    {
      ...
      "interactiveElements": [
        ...
        { "id": "newCampaign", "type": "button", "action": "/admin/email-marketing/campaigns/new sayfasına yönlendirir." }
      ],
  ...
  "roleBehavior": {
    "matrix": [
      ...
      { "role": "Marketing Team", "access": "/admin/email-marketing, /admin/social-media ve alt sayfalarına erişim. Portalda kendi dashboard'unu görür." },
  ...
  "uiElements": [
    ...
    { "name": "Chart", "description": "Sayısal verileri görselleştirmek için kullanılır. (LineChart, BarChart)", "usedIn": "/admin (Haftalık Trendler), /admin/email-marketing (Abone Büyüme)" },
  ...
  "interactiveElements": [
    ...
    { "name": "Collapsible", "description": "Genişletilebilir ve daraltılabilir içerik alanları oluşturur.", "usedIn": "/admin/email-marketing" }
  ],
  "dataSources": [
