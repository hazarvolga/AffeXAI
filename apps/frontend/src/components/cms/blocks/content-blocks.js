...
const ContentSingleFullwidth = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="content-fullwidth-container" padding="xl" background="none" className="py-16">
      <text_component_1.TextComponent id="content-fullwidth-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="text-center mb-6"/>
      <text_component_1.TextComponent id="content-fullwidth-text" content={content} variant={contentVariant} align={contentAlign} color={contentColor} weight={contentWeight} className="text-center max-w-3xl mx-auto text-muted-foreground"/>
...
const ContentTwoColumn = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="content-two-col-container" padding="xl" background="muted" className="py-16">
      <grid_component_1.GridComponent id="content-two-col-grid" columns={2} gap="xl" className="items-center">
        <div>
          <text_component_1.TextComponent id="content-two-col-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-6"/>
          <text_component_1.TextComponent id="content-two-col-text" content={content} variant={contentVariant} align={contentAlign} color={contentColor} weight={contentWeight} className="mb-6 text-muted-foreground"/>
          <button_component_1.ButtonComponent id="content-two-col-btn" text={ctaText} variant="default"/>
        </div>
        <div className="flex justify-center">
          <image_component_1.ImageComponent id="content-two-col-image" src={image} alt="Services" className="rounded-lg shadow-lg"/>
        </div>
...
const ContentThreeColumnGrid = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="content-three-col-container" padding="xl" background="none" className="py-16">
      <text_component_1.TextComponent id="content-three-col-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="text-center mb-12"/>
...
const ContentLargeSmallColumn = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="content-large-small-container" padding="xl" background="muted" className="py-16">
      <grid_component_1.GridComponent id="content-large-small-grid" columns={2} gap="xl">
        <div className="col-span-1 md:col-span-1">
          <image_component_1.ImageComponent id="content-large-small-image" src={image} alt="Story" className="rounded-lg shadow-lg w-full h-auto"/>
        </div>
        <div className="col-span-1 md:col-span-1">
          <text_component_1.TextComponent id="content-large-small-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-6"/>
          <text_component_1.TextComponent id="content-large-small-text" content={content} variant={contentVariant} align={contentAlign} color={contentColor} weight={contentWeight} className="mb-6 text-muted-foreground"/>
          <button_component_1.ButtonComponent id="content-large-small-btn" text={buttonText} href={buttonLink} variant={buttonVariant} target={buttonTarget}/>
        </div>
      </grid_component_1.GridComponent>
    </container_component_1.ContainerComponent>);
};
...
const ContentSmallLargeColumn = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="content-small-large-container" padding="xl" background="none" className="py-16">
      <grid_component_1.GridComponent id="content-small-large-grid" columns={2} gap="xl">
        <div className="col-span-1 md:col-span-1">
          <text_component_1.TextComponent id="content-small-large-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-6"/>
          <text_component_1.TextComponent id="content-small-large-text" content={content} variant={contentVariant} align={contentAlign} color={contentColor} weight={contentWeight} className="mb-6 text-muted-foreground"/>
          <button_component_1.ButtonComponent id="content-small-large-btn" text={buttonText} href={buttonLink} variant={buttonVariant} target={buttonTarget}/>
        </div>
        <div className="col-span-1 md:col-span-1">
          <image_component_1.ImageComponent id="content-small-large-image" src={image} alt="Case Study" className="rounded-lg shadow-lg w-full h-auto"/>
        </div>
      </grid_component_1.GridComponent>
    </container_component_1.ContainerComponent>);
};
