...
import { Code, FileCode, Layers, Database, Bot, Share2, Palette, ShieldCheck, Send, Settings, AlertCircle, Award, LayoutDashboard, Mail, FileText, LifeBuoy, Calendar } from "lucide-react";
...
const DocSection = ({ title, icon: Icon, children }: DocSectionProps) => (
    <Card>
        <CardHeader>
    ...
    return (
        <div className="space-y-8">
            ...
            <Alert variant="destructive">
                ...
                <AlertTitle>Bilinen Sorun: AI Dosya Oluşturma</AlertTitle>
                <AlertDescription>
            ...
            <DocSection title="Giriş" icon={FileCode}>
...
<p>This platform is designed to provide developers with a clear, scalable structure for building, testing, and extending features, ensuring rapid development while maintaining consistent UX and data integrity.</p>
            ...
            <DocSection title="Route" icon={Share2}>
                <CodeBlock>
{`src/app
...
|   |   |-- /[ticketId]: Kullanıcının kendi destek talebinin detaylarını ve mesaj geçmişini gösterir.`}
            ...
            <DocSection title="Proje Teslim Dokümanı" icon={FileText}>
            ...
            <DocSection title="Admin Dashboard (/admin)" icon={LayoutDashboard}>
                <p>
             ...
             <DocSection title="Styling ve Tema Yönetimi" icon={Palette}>
                <p>
            ...
            <DocSection title="Site Ayarları" icon={Settings}>
                <p>
            ...
            <DocSection title="Veri ve Durum Yönetimi (Simülasyon)" icon={Database}>
                <p>
            ...
            <DocSection title="Sertifika Yönetimi" icon={Award}>
                <p>
            ...
            <DocSection title="Sertifika Üretimi: Yapısal Yaklaşım ve Araçlar" icon={Award}>
  ...
  <Document>
    <Page style={styles.page}>
      ...
      <Text style={{ textAlign: 'center' }}>has completed {event}</Text>
            ...
            <DocSection title="AI Entegrasyonu (Genkit)" icon={Bot}>
                <p>
            ...
            <DocSection title="Email Marketing Modülü" icon={Mail}>
                <CodeBlock>
...
Rate-limiting ve abuse prevention`}
            ...
            <DocSection title="Sosyal Medya Modülü" icon={Share2}>
                <CodeBlock>
...
Onay süreçleri (ör. Marketing Team yazıyor, Admin onaylıyor)`}
            ...
            <DocSection title="Support Module" icon={LifeBuoy}>
                <CodeBlock>
{`    |-- /support
|   |-- /dashboard
...
Rol bazlı izinler`}
            ...
            <DocSection title="Event Module" icon={Calendar}>
                <CodeBlock>
{`Event Module
1. Overview
...
`}
            ...
            <DocSection title="CMS Module" icon={FileText}>
                <CodeBlock>
{`CMS Module
1. Overview
...
`}
            ...
            <DocSection title="Özet" icon={Layers}>
                <CodeBlock>
