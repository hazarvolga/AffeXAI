...
export declare const LineChart: import("react").ComponentType<import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps & import("react").RefAttributes<{
...
export declare const ResponsiveContainer: import("react").ComponentType<import("recharts").ResponsiveContainerProps & import("react").RefAttributes<HTMLDivElement | {
    current: HTMLDivElement;
}>>;
export declare const XAxis: import("react").ComponentType<import("recharts").XAxisProps>;
export declare const YAxis: import("react").ComponentType<import("recharts").YAxisProps>;
export declare const Tooltip: import("react").ComponentType<import("recharts").TooltipProps<import("recharts/types/component/DefaultTooltipContent").ValueType, import("recharts/types/component/DefaultTooltipContent").NameType>>;
export declare const Legend: import("react").ComponentType<import("recharts").LegendProps>;
export declare const Line: import("react").ComponentType<import("recharts").LineProps>;
export declare const CartesianGrid: import("react").ComponentType<import("recharts").CartesianGridProps>;
export declare const BarChart: import("react").ComponentType<import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps & import("react").RefAttributes<{
    readonly eventEmitterSymbol: Symbol;
    clipPathId: string;
    accessibilityManager: import("recharts/types/chart/AccessibilityManager").AccessibilityManager;
    throttleTriggeredAfterMouseMove: import("lodash").DebouncedFunc<(e: import("recharts/types/chart/generateCategoricalChart").MousePointer) => any>;
...
export declare const Bar: import("react").ComponentType<import("recharts").BarProps>;
export declare const PieChart: import("react").ComponentType<import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps & import("react").RefAttributes<{
    readonly eventEmitterSymbol: Symbol;
    clipPathId: string;
    accessibilityManager: import("recharts/types/chart/AccessibilityManager").AccessibilityManager;
    throttleTriggeredAfterMouseMove: import("lodash").DebouncedFunc<(e: import("recharts/types/chart/generateCategoricalChart").MousePointer) => any>;
...
export declare const Pie: import("react").ComponentType<import("recharts").PieProps>;
export declare const Cell: import("react").ComponentType<import("recharts").CellProps>;
//# sourceMappingURL=lazy-charts.d.ts.map