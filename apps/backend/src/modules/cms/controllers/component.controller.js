...
let ComponentController = (() => {
    let _classDecorators = [(0, common_1.Controller)('cms/components')];
    ...
    var ComponentController = class {
        ...
        static {
            ...
            _reorder_decorators = [(0, common_1.Post)('reorder')];
            ...
            ComponentController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        componentService = __runInitializers(this, _instanceExtraInitializers);
    ...
    return ComponentController = _classThis;
})();
