...
exports.BackInStockEmail = void 0;
...
const BackInStockEmail = ({ userName = "Kullanıcı", productName = "Allplan Mimari Paketi", productImageUrl = "https://picsum.photos/seed/back-in-stock/200/200", productLink = `${baseUrl}/products/allplan`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={heading}>Harika Haber!</components_1.Heading>
...
exports.BackInStockEmail = BackInStockEmail;
exports.default = exports.BackInStockEmail;
const main = {
