...
exports.default = CreateNewRolePage;
            ...
            <card_1.Card>
                ...
                <card_1.CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input_1.Input id="role-name" placeholder="Örn: Pazarlama Uzmanı"/>
                    </div>
                    <div className="space-y-2">
                        <label_1.Label htmlFor="role-description">Açıklama</label_1.Label>
                        <textarea_1.Textarea id="role-description" placeholder="Bu rolün amacını ve yetkilerini kısaca açıklayın."/>
                    </div>
                </card_1.CardContent>
            </card_1.Card>
