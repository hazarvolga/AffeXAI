...
let RolesGuard = (() => {
    ...
    var RolesGuard = class {
        ...
        async canActivate(context) {
            ...
            const hasRole = requiredRoles.some((requiredRole) => userRoleNames.some((userRole) => userRole.toLowerCase() === requiredRole.toLowerCase()));
            if (!hasRole) {
                throw new common_1.ForbiddenException(`Access denied. Required roles: ${requiredRoles.join(', ')}. User roles: ${userRoleNames.join(', ')}`);
            }
