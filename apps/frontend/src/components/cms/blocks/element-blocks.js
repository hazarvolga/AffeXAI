...
const ElementTitleButton = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="element-title-button-container" padding="md" background="none" className="flex flex-col md:flex-row justify-between items-center">
      <text_component_1.TextComponent id="element-title-button-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-4 md:mb-0"/>
      <button_component_1.ButtonComponent id="element-title-button-btn" text={buttonText} href={buttonLink} variant={buttonVariant} target={buttonTarget}/>
    </container_component_1.ContainerComponent>);
};
...
const ElementQuoteBlock = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="element-quote-container" padding="xl" background="muted" className="text-center py-12">
      <text_component_1.TextComponent id="element-quote-text" content={quote} variant={quoteVariant} align={quoteAlign} color={quoteColor} weight={quoteWeight} className="italic mb-4"/>
      <text_component_1.TextComponent id="element-quote-author" content={author} variant={authorVariant} align={authorAlign} color={authorColor} weight={authorWeight} className="font-medium"/>
    </container_component_1.ContainerComponent>);
};
...
const ElementMediaImage = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="element-media-container" padding="md" background="none" className="text-center">
      ...
      <text_component_1.TextComponent id="element-media-caption" content={caption} variant={captionVariant} align={captionAlign} color={captionColor} weight={captionWeight} className="text-muted-foreground mt-4"/>
    </container_component_1.ContainerComponent>);
};
...
const ElementTableList = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="element-table-container" padding="md" background="none">
      <card_component_1.CardComponent id="element-table-card" padding="lg" rounded="lg" shadow="md">
        <text_component_1.TextComponent id="element-table-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-4"/>
