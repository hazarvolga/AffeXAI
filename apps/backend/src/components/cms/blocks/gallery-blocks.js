...
const GallerySingleImage = () => {
    return (<container_component_1.ContainerComponent id="gallery-single-container" padding="xl" background="none" className="py-16">
      <card_component_1.CardComponent id="gallery-single-card" padding="none" rounded="lg" shadow="md">
        <image_component_1.ImageComponent id="gallery-single-image" src="/placeholder-image.jpg" alt="Featured Image" className="rounded-lg w-full h-auto"/>
        <div className="p-6">
          <text_component_1.TextComponent id="gallery-single-title" content="Featured Project" variant="heading3" className="mb-2"/>
          <text_component_1.TextComponent id="gallery-single-caption" content="Brief description of this featured project or image." variant="body" className="text-muted-foreground"/>
        </div>
...
const GalleryTwoImageSplit = () => {
    return (<container_component_1.ContainerComponent id="gallery-two-container" padding="xl" background="muted" className="py-16">
      <text_component_1.TextComponent id="gallery-two-title" content="Our Work" variant="heading2" className="text-center mb-12"/>
      <grid_component_1.GridComponent id="gallery-two-grid" columns={2} gap="xl">
        <card_component_1.CardComponent id="gallery-two-card-1" padding="none" rounded="lg" shadow="md">
          <image_component_1.ImageComponent id="gallery-two-image-1" src="/placeholder-image.jpg" alt="Project 1" className="rounded-t-lg w-full h-auto"/>
          <div className="p-6">
            <text_component_1.TextComponent id="gallery-two-card-1-title" content="Project Alpha" variant="heading3" className="mb-2"/>
            <text_component_1.TextComponent id="gallery-two-card-1-caption" content="Web design and development for a tech startup." variant="body" className="text-muted-foreground"/>
          </div>
        </card_component_1.CardComponent>
        
        <card_component_1.CardComponent id="gallery-two-card-2" padding="none" rounded="lg" shadow="md">
          <image_component_1.ImageComponent id="gallery-two-image-2" src="/placeholder-image.jpg" alt="Project 2" className="rounded-t-lg w-full h-auto"/>
          <div className="p-6">
            <text_component_1.TextComponent id="gallery-two-card-2-title" content="Project Beta" variant="heading3" className="mb-2"/>
            <text_component_1.TextComponent id="gallery-two-card-2-caption" content="Branding and marketing campaign for a retail brand." variant="body" className="text-muted-foreground"/>
          </div>
        </card_component_1.CardComponent>
