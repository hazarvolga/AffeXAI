...
exports.FeatureUpdateEmail = void 0;
...
const FeatureUpdateEmail = ({ userName = "Kullanıcı", featureName = "AI Destekli Özetleme Aracı", featureDescription = "Artık destek taleplerinizi oluştururken, yapay zeka sizin için probleminizi analiz edip bir özet ve çözüm önerisi sunacak. Bu, destek ekibimizin size daha hızlı yardımcı olmasını sağlayacak.", featureImageUrl = "https://picsum.photos/seed/feature-update/600/300", ctaLink = `${baseUrl}/portal/support/new`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={heading}>Platformumuza Yeni Bir Güç Katıldı</components_1.Heading>
            ...
            <components_1.Section style={featureSection}>
                <components_1.Heading as="h2" style={featureTitle}>{featureName}</components_1.Heading>
                <components_1.Img src={featureImageUrl} width="100%" style={featureImage}/>
                <components_1.Text style={featureText}>{featureDescription}</components_1.Text>
            </components_1.Section>
...
exports.FeatureUpdateEmail = FeatureUpdateEmail;
exports.default = exports.FeatureUpdateEmail;
const main = {
...
//# sourceMappingURL=feature-update.js.map