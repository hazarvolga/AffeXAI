...
export declare class TicketTemplatesController {
     ...
     * Create new template
     */
    create(createTemplateDto: CreateTemplateDto, userId: string): Promise<import("../entities/ticket-template.entity").TicketTemplate>;
    /**
     * Update template
     */
    update(id: string, updateTemplateDto: UpdateTemplateDto): Promise<import("../entities/ticket-template.entity").TicketTemplate>;
    /**
