...
const SocialShareButtons = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="social-share-container" padding="md" background="none">
      <text_component_1.TextComponent id="social-share-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-3"/>
      ...
      <card_component_1.CardComponent id="social-fb-card" padding="none" rounded="lg" shadow="md" className="w-full max-w-md">
        <div className="p-4 border-b">
          <div className="flex items-center">
            ...
            <div>
              <text_component_1.TextComponent id="social-fb-name" content={companyName} variant={companyNameVariant} align={companyNameAlign} color={companyNameColor} weight={companyNameWeight} className="font-medium"/>
              <text_component_1.TextComponent id="social-fb-handle" content={companyHandle} variant={companyHandleVariant} align={companyHandleAlign} color={companyHandleColor} weight={companyHandleWeight} className="text-muted-foreground text-sm"/>
            </div>
          </div>
        </div>
        <div className="p-4">
          <text_component_1.TextComponent id="social-fb-content" content={content} variant={contentVariant} align={contentAlign} color={contentColor} weight={contentWeight} className="mb-4"/>
...
const SocialInstagramGrid = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="social-ig-container" padding="md" background="none">
      <text_component_1.TextComponent id="social-ig-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="text-center mb-6"/>
...
const SocialTiktokYoutubeEmbed = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="social-video-container" padding="xl" background="muted" className="py-16">
      <text_component_1.TextComponent id="social-video-title" content={title} variant={titleVariant} align={titleAlign} color={titleColor} weight={titleWeight} className="mb-4"/>
      <text_component_1.TextComponent id="social-video-desc" content={description} variant={descriptionVariant} align={descriptionAlign} color={descriptionColor} weight={descriptionWeight} className="mb-8"/>
      <card_component_1.CardComponent id="social-video-card" padding="none" rounded="lg" shadow="md" className="max-w-3xl mx-auto">
        ...
        <div className="p-6">
          <text_component_1.TextComponent id="social-video-video-title" content={videoTitle} variant="heading3" align="left" color="primary" weight="bold" className="mb-2"/>
          <text_component_1.TextComponent id="social-video-video-desc" content={videoDescription} variant="body" align="left" color="muted" weight="normal" className="mb-4"/>
