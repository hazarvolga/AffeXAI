...
const ticket_status_enum_1 = require("../../modules/tickets/enums/ticket-status.enum");
const ticket_priority_enum_1 = require("../../modules/tickets/enums/ticket-priority.enum");
async function seedTickets() {
    try {
        ...
        const supportUser = await queryRunner.query("SELECT id FROM users WHERE email = 'support@aluplan.com'");
        ...
        const customerUser = await queryRunner.query("SELECT id FROM users WHERE email = 'customer@aluplan.com'");
      ...
      `);
        ...
        const category = await queryRunner.query("SELECT id FROM ticket_categories WHERE name = 'Teknik Destek'");
        ...
        const tickets = [
            {
                ...
                priority: ticket_priority_enum_1.TicketPriority.HIGH,
            ...
            },
            {
                ...
                priority: ticket_priority_enum_1.TicketPriority.MEDIUM,
        ...
        for (const ticket of tickets) {
            ...
            const existingTicket = await queryRunner.query('SELECT id FROM tickets WHERE subject = $1', [ticket.subject]);
...
seedTickets();
//# sourceMappingURL=seed-tickets.js.map