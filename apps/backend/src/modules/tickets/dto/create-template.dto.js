...
exports.CreateTicketTemplateDto = void 0;
...
let CreateTicketTemplateDto = (() => {
    ...
    return class CreateTicketTemplateDto {
        static {
...
exports.CreateTicketTemplateDto = CreateTicketTemplateDto;
