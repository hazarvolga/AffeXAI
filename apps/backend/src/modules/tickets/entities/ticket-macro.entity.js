 ...
 */
let TicketMacro = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('ticket_macros')];
    ...
    var TicketMacro = class {
        ...
        static {
            ...
            _createdBy_decorators = [(0, typeorm_1.ManyToOne)(() => user_entity_1.User), (0, typeorm_1.JoinColumn)({ name: 'createdById' })];
            _actions_decorators = [(0, typeorm_1.Column)({ type: 'jsonb' })];
            ...
            _usageCount_decorators = [(0, typeorm_1.Column)({ type: 'integer', default: 0 })];
            ...
            TicketMacro = _classThis = _classDescriptor.value;
        ...
        createdById = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _createdById_initializers, void 0));
        createdBy = (__runInitializers(this, _createdById_extraInitializers), __runInitializers(this, _createdBy_initializers, void 0));
        actions = (__runInitializers(this, _createdBy_extraInitializers), __runInitializers(this, _actions_initializers, void 0));
        isActive = (__runInitializers(this, _actions_extraInitializers), __runInitializers(this, _isActive_initializers, void 0));
        isPublic = (__runInitializers(this, _isActive_extraInitializers), __runInitializers(this, _isPublic_initializers, void 0)); // Available to all agents
        usageCount = (__runInitializers(this, _isPublic_extraInitializers), __runInitializers(this, _usageCount_initializers, void 0));
        tags = (__runInitializers(this, _usageCount_extraInitializers), __runInitializers(this, _tags_initializers, void 0));
        createdAt = (__runInitializers(this, _tags_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
        updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, void 0));
        constructor() {
            __runInitializers(this, _updatedAt_extraInitializers);
        }
    };
    return TicketMacro = _classThis;
})();
exports.TicketMacro = TicketMacro;
//# sourceMappingURL=ticket-macro.entity.js.map