    ...
    return (<>
         <div className="flex items-center justify-between space-y-2">
            ...
            <button_1.Button asChild>
                <link_1.default href="/admin">Yönetim Paneline Git</link_1.default>
            </button_1.Button>
        </div>
            ...
            <card_1.Card>
                ...
                <card_1.CardContent className="flex justify-around">
                 ...
                 <card_1.CardFooter className="flex justify-end">
                    <button_1.Button asChild size="sm" variant="outline">
                       <link_1.default href="/admin/email-marketing">Tümünü Gör <lucide_react_1.ArrowUpRight className="h-4 w-4 ml-2"/></link_1.default>
                    </button_1.Button>
                </card_1.CardFooter>
            </card_1.Card>
            <card_1.Card>
