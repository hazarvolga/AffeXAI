...
exports.portalDarkTokens = exports.portalLightTokens = exports.adminDarkTokens = exports.adminLightTokens = exports.defaultTokens = exports.components = exports.animations = exports.shadows = exports.typography = exports.borderRadius = exports.spacing = exports.publicDarkColors = exports.publicLightColors = exports.baseColors = void 0;
/**
...
exports.defaultTokens = {
    color: {
        ...exports.baseColors.color,
        ...exports.publicLightColors.color,
    },
    spacing: exports.spacing.spacing,
    radius: exports.borderRadius.radius,
    fontFamily: exports.typography.fontFamily,
    fontWeight: exports.typography.fontWeight,
    fontSize: exports.typography.fontSize,
    lineHeight: exports.typography.lineHeight,
    shadow: exports.shadows.shadow,
    duration: exports.animations.duration,
    easing: exports.animations.easing,
    button: exports.components.button,
    card: exports.components.card,
    input: exports.components.input,
};
/**
 * Admin theme tokens (LIGHT mode)
 */
exports.adminLightTokens = {
    color: {
        ...exports.baseColors.color,
        ...exports.publicLightColors.color,
    },
 ...
 */
exports.adminDarkTokens = {
    color: {
        ...exports.baseColors.color,
        ...exports.publicDarkColors.color,
    },
    spacing: exports.spacing.spacing,
    radius: exports.borderRadius.radius,
    fontFamily: exports.typography.fontFamily,
