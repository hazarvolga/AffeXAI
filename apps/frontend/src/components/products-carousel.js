...
exports.ProductsCarousel = ProductsCarousel;
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl text-center mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            İhtiyaçlarınıza özel olarak tasarlanmış, sektör lideri Allplan ve iş ortağı ürünlerini keşfedin.
          </p>
        </div>
        ...
        <carousel_1.Carousel setApi={setMainApi} opts={{ loop: true }} className="w-full">
          <carousel_1.CarouselContent>
            {products_data_1.productsData.map((slide) => (<carousel_1.CarouselItem key={slide.id}>
        ...
        <div className="mt-8">
          <carousel_1.Carousel setApi={setThumbApi} opts={{
            ...
            <carousel_1.CarouselContent className="-ml-4">
              {products_data_1.productsData.map((slide, index) => (<carousel_1.CarouselItem key={slide.id} onClick={() => onThumbClick(index)} className="pl-4 basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5 group">
...
//# sourceMappingURL=products-carousel.js.map