...
function Header() {
    ...
    const [lightLogoUrl, setLightLogoUrl] = (0, react_1.useState)('https://placehold.co/140x40/f7f7f7/1a1a1a?text=Logo');
    const [darkLogoUrl, setDarkLogoUrl] = (0, react_1.useState)('https://placehold.co/140x40/171717/f0f0f0?text=Logo');
    (0, react_1.useEffect)(() => {
        const handleScroll = () => {
        ...
        const fetchSiteSettings = async () => {
            try {
                ...
                if (settings.logoUrl) {
                    ...
                    const url = await mediaService_1.default.getMediaUrl(settings.logoUrl);
                ...
                if (settings.logoDarkUrl) {
                    ...
                    const url = await mediaService_1.default.getMediaUrl(settings.logoDarkUrl);
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-10 flex items-center justify-between text-xs">
            ...
            return (<a key={platform} href={url} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
              ...
              <div className="flex items-center gap-4 font-medium">
                  <link_1.default href="/login" className="hover:text-primary transition-colors flex items-center gap-1.5">
                    <lucide_react_1.UserCog className="h-4 w-4"/> Giriş Yap
                  </link_1.default>
                  <div className="w-px h-4 bg-border"></div>
                  <link_1.default href="/signup" className="hover:text-primary transition-colors flex items-center gap-1.5">
                    <lucide_react_1.User className="h-4 w-4"/> Kayıt Ol
                  </link_1.default>
                  <div className="w-px h-4 bg-border"></div>
      ...
      <header>
        <div className="container mx-auto flex h-28 items-center justify-between px-4 sm:px-6 lg:px-8 py-2">
           <link_1.default href="/" className="flex items-center gap-2 font-semibold">
                ...
                <img className="dark:hidden h-auto" src={getDynamicLogoUrl(false) || 'https://placehold.co/140x40/f7f7f7/1a1a1a?text=Logo'} alt={`${siteSettings.companyName} Logo`} width={200} height={60} onError={(e) => {
            ...
            e.currentTarget.src = 'https://placehold.co/140x40/f7f7f7/1a1a1a?text=Logo';
                ...
                <img className="hidden dark:block h-auto" src={getDynamicLogoUrl(true) || 'https://placehold.co/140x40/171717/f0f0f0?text=Logo'} alt={`${siteSettings.companyName} Logo`} width={200} height={60} onError={(e) => {
              ...
              <sheet_1.SheetContent side="left" className="w-full max-w-xs p-0 flex flex-col">
                  <div className="flex items-center justify-between p-4 border-b">
                      <link_1.default href="/" className="text-xl font-bold text-primary">
                        <img src={getDynamicLogoUrl(false) || 'https://placehold.co/140x40/f7f7f7/1a1a1a?text=Logo'} alt={`${siteSettings.companyName} Logo`} width={160} height={45} className="h-auto" onError={(e) => {
