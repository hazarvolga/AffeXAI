...
exports.AddTicketMessageEditingFields1760789880000 = void 0;
const typeorm_1 = require("typeorm");
class AddTicketMessageEditingFields1760789880000 {
    async up(queryRunner) {
        // Check and add isEdited column
        const hasIsEdited = await queryRunner.hasColumn('ticket_messages', 'isEdited');
        if (!hasIsEdited) {
            await queryRunner.addColumn('ticket_messages', new typeorm_1.TableColumn({
                name: 'isEdited',
                type: 'boolean',
                default: false,
            }));
...
exports.AddTicketMessageEditingFields1760789880000 = AddTicketMessageEditingFields1760789880000;
//# sourceMappingURL=1760789880000-AddTicketMessageEditingFields.js.map