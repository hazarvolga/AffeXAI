    ...
    blocks: [
      ...
      },
      {
        ...
        props: {
          ...
          description: 'Kurumsal düzeyde hizmetler ile işletmenizi geleceğe taşıyın. Uluslararası standartlarda çözümler sunuyoruz.',
          stats: [
            { value: '20+', label: 'Yıllık Deneyim' },
            { value: '500+', label: 'Mutlu Müşteri' },
            { value: '1000+', label: 'Başarılı Proje' },
          ],
      ...
      },
      {
        ...
        props: {
          ...
          subtitle: 'Fortune 500 şirketleri dahil önde gelen kurumlarla çalışıyoruz',
          columns: 6,
          logos: [
      ...
      },
      {
        ...
        props: {
          title: 'Şirket Tarihçemiz',
          subtitle: '20 yıllık başarı hikayemiz',
          events: [
            { date: '2000', title: 'Kuruluş', description: 'İstanbul\'da 5 kişilik ekiple yola çıktık', status: 'completed' },
            { date: '2005', title: 'İlk 100 Müşteri', description: 'Müşteri portföyümüzü genişlettik', status: 'completed' },
            { date: '2010', title: 'Uluslararası Açılım', description: 'Avrupa pazarına girdik', status: 'completed' },
            { date: '2015', title: 'Dijital Dönüşüm', description: 'Bulut tabanlı çözümler geliştirdik', status: 'completed' },
            { date: '2020', title: '500+ Müşteri', description: 'Sektörde lider konuma geldik', status: 'current' },
            { date: '2025', title: 'Global Genişleme', description: 'Asya ve Amerika pazarlarına açılıyoruz', status: 'upcoming' },
          ],
          paddingTop: '5rem',
          paddingBottom: '5rem',
        },
      },
      {
        ...
        props: {
          ...
          testimonials: [
            {
              quote: 'Profesyonel yaklaşımları ve kaliteli hizmetleri ile işimizi çok ileri taşıdılar. Dijital dönüşüm sürecimiz kusursuz yönetildi.',
              author: {
                name: 'Can Öztürk',
                role: 'CEO',
                company: 'Tech Corp',
            ...
            {
              quote: 'Yıllardır birlikte çalıştığımız güvenilir iş ortağımız. Müşteri memnuniyeti ve çözüm odaklı yaklaşımları takdire şayan.',
              author: {
                name: 'Ayşe Demir',
                role: 'CTO',
  ...
  // ==================== SOLUTIONS PAGE ====================
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'hero-solutions',
        props: {
          eyebrow: 'İş Çözümlerimiz',
          title: 'Her Sektör İçin Özel Çözümler',
          subtitle: 'İşinize Özel Dijital Dönüşüm',
          description: 'İnşaat, enerji, sanayi ve daha fazlası için entegre çözümler. Kanıtlanmış metodolojilerimizle işinizi dönüştürün.',
          features: [
            { text: 'Sektöre Özel Çözümler', icon: 'target' },
            { text: 'Hızlı Entegrasyon & Minimum Kesinti', icon: 'zap' },
            { text: '7/24 Uzman Destek', icon: 'headset' },
            { text: 'ISO 27001 Sertifikalı Güvenlik', icon: 'shield-check' },
          ],
          imageUrl: '/solutions-hero.jpg',
          primaryButtonText: 'Çözümleri Keşfet',
          primaryButtonUrl: '#solutions',
          secondaryButtonText: 'Demo Talep Et',
          secondaryButtonUrl: '/demo',
          trustBadge: { text: 'ISO 27001 Sertifikalı', icon: 'badge-check' },
          paddingTop: '6rem',
          paddingBottom: '6rem',
        },
      },
      {
        ...
        type: 'client-logo-grid',
        props: {
          title: 'Güvenilen İş Ortağınız',
          subtitle: 'Türkiye\'nin önde gelen şirketleri bize güveniyor',
          columns: 5,
          logos: [
            { name: 'Client 1', logoUrl: 'https://via.placeholder.com/200x80/e5e7eb/6b7280?text=Client+1' },
            { name: 'Client 2', logoUrl: 'https://via.placeholder.com/200x80/e5e7eb/6b7280?text=Client+2' },
      ...
      },
      {
        ...
        props: {
          ...
          subtitle: 'Dijital Dönüşüm Yolculukları',
          testimonials: [
            {
              quote: 'Tüm şirket gruplarımızı tek platformda yönetiyoruz. Verimlilik %40 arttı, operasyonel maliyetlerimiz düştü.',
              author: {
                name: 'Zeynep Arslan',
              ...
              rating: 5,
              logo: '/logos/abc-holding.svg',
            },
            {
              quote: 'Proje süreçlerimizi tamamen dijitalleştirdik. Maliyet tasarrufu çok yüksek, projelerimizi zamanında teslim ediyoruz.',
              author: {
                name: 'Kerem Öztürk',
                role: 'Genel Müdür',
                company: 'XYZ İnşaat',
              ...
              rating: 5,
              logo: '/logos/xyz-construction.svg',
            },
            {
              quote: 'Müşteri memnuniyetimiz %98\'e yükseldi. Sistemin kullanımı çok kolay ve entegrasyon sorunsuz oldu.',
              author: {
                name: 'Elif Kaya',
                role: 'CTO',
