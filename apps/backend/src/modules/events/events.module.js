...
let EventsModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([event_entity_1.Event, event_registration_entity_1.EventRegistration]),
                shared_module_1.SharedModule,
                certificates_module_1.CertificatesModule, // Import to use BulkCertificateService
                platform_integration_module_1.PlatformIntegrationModule, // Import to use EventBusService
            ],
            controllers: [events_controller_1.EventsController],
            providers: [events_service_1.EventsService],
            exports: [events_service_1.EventsService, typeorm_1.TypeOrmModule],
        })];
