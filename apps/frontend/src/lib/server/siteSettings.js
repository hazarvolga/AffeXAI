...
async function getSiteSettings() {
    ...
    return {
        companyName: site_settings_data_1.siteSettingsData.companyName || 'Aluplan',
        logoUrl,
        logoDarkUrl,
        tagline: site_settings_data_1.siteSettingsData.tagline,
        address: site_settings_data_1.siteSettingsData.address || '',
        phone: site_settings_data_1.siteSettingsData.phone || '',
        email: site_settings_data_1.siteSettingsData.email || '',
        contactEmail: site_settings_data_1.siteSettingsData.contactEmail || site_settings_data_1.siteSettingsData.email || '',
        socialMedia: {
            facebook: site_settings_data_1.siteSettingsData.facebook || '',
            twitter: site_settings_data_1.siteSettingsData.twitter || '',
            instagram: site_settings_data_1.siteSettingsData.instagram || '',
            linkedin: site_settings_data_1.siteSettingsData.linkedin || '',
            youtube: site_settings_data_1.siteSettingsData.youtube || ''
        }
    };
}
/**
