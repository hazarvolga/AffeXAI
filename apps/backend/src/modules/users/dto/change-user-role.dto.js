...
let ChangeUserRoleDto = (() => {
    let _roleId_decorators;
    let _roleId_initializers = [];
    let _roleId_extraInitializers = [];
    return class ChangeUserRoleDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _roleId_decorators = [(0, swagger_1.ApiProperty)({ description: 'New role ID (UUID)', example: 'a1b2c3d4-e5f6-4789-abcd-000000000001' }), (0, class_validator_1.IsUUID)(), (0, class_validator_1.IsNotEmpty)()];
        ...
        roleId = __runInitializers(this, _roleId_initializers, void 0);
        constructor() {
