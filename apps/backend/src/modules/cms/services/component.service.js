...
let ComponentService = (() => {
    ...
    var ComponentService = class {
        ...
        static {
            ...
            ComponentService = _classThis = _classDescriptor.value;
        ...
        async update(id, updateComponentDto) {
            ...
            if (!component) {
                throw new common_1.NotFoundException(`Component with ID ${id} not found`);
            }
            return component;
        }
        async remove(id) {
    ...
    return ComponentService = _classThis;
})();
