...
const document_processor_service_1 = require("../src/modules/chat/services/document-processor.service");
const file_validator_service_1 = require("../src/modules/chat/services/file-validator.service");
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                {
                    provide: file_validator_service_1.FileValidatorService,
        ...
        service = module.get(document_processor_service_1.DocumentProcessorService);
        fileValidator = module.get(file_validator_service_1.FileValidatorService);
        repository = module.get((0, typeorm_1.getRepositoryToken)(chat_document_entity_1.ChatDocument));
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
...
describe('FileValidatorService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [file_validator_service_1.FileValidatorService],
        }).compile();
        service = module.get(file_validator_service_1.FileValidatorService);
    });
...
//# sourceMappingURL=document-processing.test.js.map