...
let CategoryController = (() => {
    let _classDecorators = [(0, common_1.Controller)('cms/categories')];
    ...
    var CategoryController = class {
        ...
        static {
            ...
            _getTree_decorators = [(0, common_1.Get)('tree')];
            ...
            _reorder_decorators = [(0, common_1.Post)('reorder'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        ...
        async findAll(parentId, isActive, search) {
            const params = {};
