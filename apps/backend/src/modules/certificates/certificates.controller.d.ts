...
export declare class CertificatesController {
    ...
    createTemplate(dto: CreateCertificateTemplateDto): Promise<import("./entities/certificate-template.entity").CertificateTemplate>;
    ...
    updateTemplate(id: string, dto: UpdateCertificateTemplateDto): Promise<import("./entities/certificate-template.entity").CertificateTemplate>;
