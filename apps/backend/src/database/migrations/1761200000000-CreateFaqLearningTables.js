...
exports.CreateFaqLearningTables1761200000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateFaqLearningTables1761200000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createForeignKey('learned_faq_entries', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createForeignKey('faq_learning_config', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createIndex('learning_patterns', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('learned_faq_entries', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('faq_learning_config', new typeorm_1.TableIndex({
...
exports.CreateFaqLearningTables1761200000000 = CreateFaqLearningTables1761200000000;
//# sourceMappingURL=1761200000000-CreateFaqLearningTables.js.map