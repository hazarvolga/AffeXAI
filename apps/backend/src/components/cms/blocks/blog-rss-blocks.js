      ...
      <card_component_1.CardComponent id="blog-extended-card" padding="none" rounded="lg" shadow="md">
        ...
        <div className="p-8">
          <div className="flex items-center mb-4">
            <text_component_1.TextComponent id="blog-extended-category" content={category} variant="body" className="text-primary font-medium mr-4"/>
            <text_component_1.TextComponent id="blog-extended-date" content={date} variant="body" className="text-muted-foreground"/>
          </div>
          <text_component_1.TextComponent id="blog-extended-title" content={title} variant="heading1" className="mb-4"/>
          <text_component_1.TextComponent id="blog-extended-excerpt" content={excerpt} variant="body" className="mb-6 text-muted-foreground text-lg"/>
          <div className="flex items-center">
            ...
            <text_component_1.TextComponent id="blog-extended-author" content={authorName} variant="body" className="font-medium"/>
          </div>
        </div>
...
const BlogBasicList = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="blog-basic-container" padding="xl" background="muted" className="py-16">
      <text_component_1.TextComponent id="blog-basic-title" content={title} variant="heading2" className="mb-12"/>
...
const BlogDoublePostHighlight = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="blog-double-container" padding="xl" background="none" className="py-16">
      <text_component_1.TextComponent id="blog-double-title" content={title} variant="heading2" className="text-center mb-12"/>
...
const BlogMiniHighlight = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="blog-mini-container" padding="md" background="none">
      <card_component_1.CardComponent id="blog-mini-card" padding="lg" rounded="lg" shadow="md">
        <text_component_1.TextComponent id="blog-mini-title" content={title} variant="heading3" className="mb-4"/>
    ...
    return (<container_component_1.ContainerComponent id="blog-author-left-container" padding="xl" background="muted" className="py-16">
      <card_component_1.CardComponent id="blog-author-left-card" padding="lg" rounded="lg" shadow="md">
        <grid_component_1.GridComponent id="blog-author-left-grid" columns={2} gap="xl" className="items-center">
          ...
          <div>
            <text_component_1.TextComponent id="blog-author-left-name" content={authorName} variant="heading2" className="mb-2"/>
            <text_component_1.TextComponent id="blog-author-left-title" content={authorTitle} variant="body" className="text-primary font-medium mb-4"/>
            <text_component_1.TextComponent id="blog-author-left-bio" content={authorBio} variant="body" className="text-muted-foreground mb-6"/>
...
const BlogAuthorBioCentered = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="blog-author-centered-container" padding="xl" background="none" className="py-16">
      <card_component_1.CardComponent id="blog-author-centered-card" padding="lg" rounded="lg" shadow="md" className="text-center max-w-2xl mx-auto">
        ...
        <text_component_1.TextComponent id="blog-author-centered-name" content={authorName} variant="heading2" className="mb-2"/>
        <text_component_1.TextComponent id="blog-author-centered-title" content={authorTitle} variant="body" className="text-primary font-medium mb-4"/>
        <text_component_1.TextComponent id="blog-author-centered-bio" content={authorBio} variant="body" className="text-muted-foreground mb-6"/>
...
const BlogRssFeaturedArticle = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="blog-rss-featured-container" padding="xl" background="muted" className="py-16">
      <div className="flex items-center mb-4">
        <text_component_1.TextComponent id="blog-rss-featured-source" content={source} variant="body" className="text-primary font-medium mr-4"/>
        <text_component_1.TextComponent id="blog-rss-featured-date" content={date} variant="body" className="text-muted-foreground"/>
      </div>
      <card_component_1.CardComponent id="blog-rss-featured-card" padding="lg" rounded="lg" shadow="md">
        <text_component_1.TextComponent id="blog-rss-featured-title" content={title} variant="heading2" className="mb-4"/>
        <text_component_1.TextComponent id="blog-rss-featured-excerpt" content={excerpt} variant="body" className="mb-6 text-muted-foreground"/>
        <div className="flex items-center justify-between">
          <text_component_1.TextComponent id="blog-rss-featured-author" content={author} variant="body" className="font-medium"/>
...
const BlogRssList = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="blog-rss-list-container" padding="xl" background="none" className="py-16">
      <div className="flex items-center mb-6">
        <text_component_1.TextComponent id="blog-rss-list-source" content={source} variant="body" className="text-primary font-medium mr-4"/>
        <text_component_1.TextComponent id="blog-rss-list-title" content={title} variant="heading2" className="flex-1"/>
