...
exports.AddAbTestingSupport1736284800000 = void 0;
const typeorm_1 = require("typeorm");
class AddAbTestingSupport1736284800000 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.createForeignKey('email_campaign_variants', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createIndex('email_campaign_variants', new typeorm_1.TableIndex({
        ...
        await queryRunner.createForeignKey('email_campaigns', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createIndex('email_campaigns', new typeorm_1.TableIndex({
...
exports.AddAbTestingSupport1736284800000 = AddAbTestingSupport1736284800000;
//# sourceMappingURL=1736284800000-AddAbTestingSupport.js.map