...
const faq_learning_module_1 = require("./modules/faq-learning/faq-learning.module");
const chat_module_1 = require("./modules/chat/chat.module");
const knowledge_sources_module_1 = require("./modules/knowledge-sources/knowledge-sources.module");
...
let AppModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                knowledge_sources_module_1.KnowledgeSourcesModule,
            ],
