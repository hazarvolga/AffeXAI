...
let Media = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('media')];
    ...
    var Media = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _filename_decorators = [(0, typeorm_1.Column)()];
            _originalName_decorators = [(0, typeorm_1.Column)()];
            _mimeType_decorators = [(0, typeorm_1.Column)()];
            _size_decorators = [(0, typeorm_1.Column)({ type: 'bigint' })];
            ...
            _type_decorators = [(0, typeorm_1.Column)({
                    type: 'enum',
                    enum: shared_types_1.MediaType,
                    default: shared_types_1.MediaType.IMAGE,
                })];
            _storageType_decorators = [(0, typeorm_1.Column)({
                    type: 'enum',
                    enum: shared_types_1.StorageType,
                    default: shared_types_1.StorageType.LOCAL,
                })];
            _altText_decorators = [(0, typeorm_1.Column)({ nullable: true })];
