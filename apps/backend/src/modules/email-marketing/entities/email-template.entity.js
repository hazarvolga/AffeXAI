...
Object.defineProperty(exports, "TemplateType", { enumerable: true, get: function () { return shared_types_1.TemplateType; } });
let EmailTemplate = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('email_templates')];
    ...
    var EmailTemplate = class extends _classSuper {
        ...
        static {
            ...
            _type_decorators = [(0, typeorm_1.Column)({
                    type: 'enum',
                    enum: shared_types_1.TemplateType,
                    default: shared_types_1.TemplateType.FILE_BASED,
                })];
            _fileTemplateName_decorators = [(0, typeorm_1.Column)({ nullable: true })];
            _variables_decorators = [(0, typeorm_1.Column)({ type: 'jsonb', nullable: true })];
