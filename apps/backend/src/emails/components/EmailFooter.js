...
const EmailFooter = ({ companyName, contactInfo, socialMediaLinks, showUnsubscribeLink = true, baseUrl, locale = 'tr', }) => {
    const t = {
    ...
    return (<>
      ...
      <components_1.Section style={footer}>
        ...
        {showUnsubscribeLink && (<components_1.Text style={footerText}>
            <components_1.Link href={`${baseUrl}/unsubscribe`} style={footerLink}>
              {t.unsubscribe}
            </components_1.Link>
          </components_1.Text>)}
      </components_1.Section>
