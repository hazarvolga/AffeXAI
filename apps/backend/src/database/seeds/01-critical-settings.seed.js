...
exports.seedCriticalSettings = seedCriticalSettings;
const setting_entity_1 = require("../../modules/settings/entities/setting.entity");
async function seedCriticalSettings(dataSource) {
    const settingsRepo = dataSource.getRepository(setting_entity_1.Setting);
    ...
    const settings = [
        ...
        // ==========================================
        {
            category: setting_entity_1.SettingCategory.COMPANY,
            key: 'name',
        ...
        // ==========================================
        {
            category: setting_entity_1.SettingCategory.EMAIL,
            key: 'provider',
        ...
        // ==========================================
        {
            category: setting_entity_1.SettingCategory.AI,
            key: 'useSingleApiKey',
            value: 'false',
            isEncrypted: false,
        },
        ...
        // ==========================================
        {
            category: setting_entity_1.SettingCategory.ANALYTICS,
            key: 'enabled',
            value: 'true',
            isEncrypted: false,
        },
        ...
        // ==========================================
        {
            category: setting_entity_1.SettingCategory.SOCIAL_MEDIA,
            key: 'enabled',
...
//# sourceMappingURL=01-critical-settings.seed.js.map