...
exports.FloatingTextarea = void 0;
const React = __importStar(require("react"));
const textarea_1 = require("@/components/ui/textarea");
const label_1 = require("@/components/ui/label");
const utils_1 = require("@/lib/utils");
const FloatingTextarea = React.forwardRef(({ className, label, id, ...props }, ref) => {
    const inputId = id || `floating-textarea-${label.toLowerCase().replace(/\s/g, '-')}`;
    return (<div className="relative">
        <textarea_1.Textarea ref={ref} id={inputId} className={(0, utils_1.cn)('peer placeholder-transparent', className)} placeholder={label} {...props}/>
...
exports.FloatingTextarea = FloatingTextarea;
FloatingTextarea.displayName = 'FloatingTextarea';
//# sourceMappingURL=floating-textarea.js.map