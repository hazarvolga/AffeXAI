...
const EmailVerificationEmail = ({ userName = 'Değerli Kullanıcı', verificationLink = `${baseUrl}/portal/verify-email`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Text style={heading}>
            ...
            <components_1.Section style={buttonContainer}>
              <components_1.Button style={button} href={verificationLink}>
...
exports.default = exports.EmailVerificationEmail;
const main = {
