...
exports.TicketCreatedEmail = void 0;
...
const TicketCreatedEmail = ({ ticketId = "07a6cc03-5ed9-483e-b26c-da0f3c4a4b83", ticketNumber = "#12345", subject = "Test Destek Talebi", priority = "medium", customerName = "Değerli Müşterimiz", ticketUrl = `${baseUrl}/portal/support/tickets/07a6cc03-5ed9-483e-b26c-da0f3c4a4b83`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={h1}>Destek Talebiniz Alındı</components_1.Heading>
            ...
            <components_1.Section style={ticketBox}>
              <components_1.Text style={ticketLabel}>Talep Numarası:</components_1.Text>
              <components_1.Text style={ticketValue}>{ticketNumber}</components_1.Text>
              ...
              <components_1.Text style={ticketLabel}>Öncelik:</components_1.Text>
              <components_1.Text style={ticketValue}>{priorityLabels[priority] || priority}</components_1.Text>
            </components_1.Section>
            ...
            <components_1.Text style={helpText}>
...
exports.TicketCreatedEmail = TicketCreatedEmail;
exports.default = exports.TicketCreatedEmail;
// Styles
const main = {
