...
const GoodbyeEmail = ({ userName = 'Değerli Kullanıcı', feedbackLink = `${baseUrl}/contact`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={heading}>Hoşça Kalın</components_1.Heading>
            ...
            <components_1.Text style={paragraph}>
             ...
             <components_1.Section style={buttonContainer}>
                <components_1.Link href={feedbackLink} style={feedbackLinkStyle}>Geri Bildirimde Bulun</components_1.Link>
            </components_1.Section>
            <components_1.Text style={paragraph}>
...
exports.GoodbyeEmail = GoodbyeEmail;
exports.default = exports.GoodbyeEmail;
const main = {
