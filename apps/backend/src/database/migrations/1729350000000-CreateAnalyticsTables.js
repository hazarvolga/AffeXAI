...
exports.CreateAnalyticsTables1729350000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateAnalyticsTables1729350000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createIndex('analytics_events', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('analytics_sessions', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('analytics_heatmaps', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('ab_tests', new typeorm_1.TableIndex({
        ...
        await queryRunner.createForeignKey('ab_test_variants', new typeorm_1.TableForeignKey({
            columnNames: ['testId'],
        ...
        await queryRunner.createIndex('ab_test_variants', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('component_performance', new typeorm_1.TableIndex({
...
exports.CreateAnalyticsTables1729350000000 = CreateAnalyticsTables1729350000000;
//# sourceMappingURL=1729350000000-CreateAnalyticsTables.js.map