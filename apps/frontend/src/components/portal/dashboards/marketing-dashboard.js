                ...
                <card_1.Card>
                    ...
                    <card_1.CardContent className="grid gap-4 sm:grid-cols-2">
                         <button_1.Button asChild size="lg" className="h-auto py-4 text-left justify-start">
                            <link_1.default href="/admin/email-marketing/campaigns/new">
                ...
                {latestCampaign && (<card_1.Card>
                    ...
                    <card_1.CardFooter>
                        <button_1.Button variant="outline" asChild>
                            <link_1.default href={`/admin/email-marketing/campaigns/${latestCampaign.id}`}>Detaylı Raporu Gör</link_1.default>
                        </button_1.Button>
                    </card_1.CardFooter>
                </card_1.Card>)}
            </div>
