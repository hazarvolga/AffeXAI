...
exports.AccountSummaryEmail = void 0;
...
const AccountSummaryEmail = ({ userName = "Ahmet", month = "Ağustos 2024", newTickets = 2, resolvedTickets = 1, newCertificates = 1, ctaLink = `${baseUrl}/portal/dashboard`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={heading}>{month} Özeti</components_1.Heading>
            ...
            <components_1.Section style={summarySection}>
                <div style={summaryItem}>
                    <components_1.Text style={summaryValue}>{newTickets}</components_1.Text>
                    <components_1.Text style={summaryLabel}>Yeni Destek Talebi</components_1.Text>
                </div>
                 <div style={summaryItem}>
                    <components_1.Text style={summaryValue}>{resolvedTickets}</components_1.Text>
                    <components_1.Text style={summaryLabel}>Çözülen Destek Talebi</components_1.Text>
                </div>
                 <div style={summaryItem}>
                    <components_1.Text style={summaryValue}>{newCertificates}</components_1.Text>
                    <components_1.Text style={summaryLabel}>Kazanılan Sertifika</components_1.Text>
                </div>
            </components_1.Section>
          ...
          <EmailFooter_1.EmailFooter companyName={companyName} contactInfo={contactInfo} socialMediaLinks={socialMediaLinks} baseUrl={baseUrl} showUnsubscribeLink={false} // This is an informational email, so no unsubscribe link
    />
        </components_1.Container>
      </components_1.Body>
    </components_1.Html>);
};
exports.AccountSummaryEmail = AccountSummaryEmail;
exports.default = exports.AccountSummaryEmail;
const main = {
