...
import { TrackableBlock } from './trackable-block';
...
export function TemplateRenderer({
  ...
  return (
    <div 
      ...
      data-design-system={designSystem?.preferredMode || 'light'}
    >
      {blocks.map((block) => {
...
export function BlockRenderer({ 
  ...
  if (!BlockComponent) {
    return (
      <div className="p-4 border-2 border-dashed border-red-300 bg-red-50 rounded">
  ...
  if (enableTracking) {
    return (
      <TrackableBlock block={block} pageId={pageId}>
        <BlockComponent {...block.properties} blockId={block.id} />
      </TrackableBlock>
    );
  }
 ...
 */
function getBlockComponent(blockType: string): React.ComponentType<any> | null {
  ...
  return (
    ...
    >
      <div className="container mx-auto">
        ...
        {props.primaryCta && (
          <button data-cta="true" data-cta-type="primary">
            {props.primaryCta.text}
          </button>
        )}
        {props.secondaryCta && (
          <button data-cta="true" data-cta-type="secondary">
...
function FeaturesBlock(props: any) {
  return (
    <section className="features-block py-16" style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto">
        <h2 style={{ color: props.titleColor }}>{props.title}</h2>
        <p style={{ color: props.subtitleColor }}>{props.subtitle}</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {props.features?.map((feature: any, index: number) => (
            <div key={index} className="feature-card p-6" style={{ backgroundColor: props.cardBackground }}>
...
function StatsBlock(props: any) {
  return (
    <section className="stats-block py-12" style={{ backgroundColor: props.backgroundColor }}>
...
function TestimonialsBlock(props: any) {
  return (
    <section className="testimonials-block py-16" style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {props.testimonials?.map((testimonial: any, index: number) => (
            <div key={index} className="testimonial-card p-6" style={{ backgroundColor: props.cardBackground }}>
...
function PricingBlock(props: any) {
  return (
    <section className="pricing-block py-16" style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto">
        <h2 className="text-center mb-12" style={{ color: props.titleColor }}>{props.title}</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {props.plans?.map((plan: any, index: number) => (
            ...
            >
              ...
              {plan.price?.custom ? (
                <p className="text-2xl mt-4" style={{ color: props.priceColor }}>Custom</p>
              ) : (
                <p className="text-4xl mt-4" style={{ color: props.priceColor }}>
...
function FAQBlock(props: any) {
  return (
    <section className="faq-block py-16" style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto max-w-3xl">
        <h2 className="text-center mb-12" style={{ color: props.titleColor }}>{props.title}</h2>
        <div className="space-y-4">
          {props.questions?.map((item: any, index: number) => (
            <div key={index} className="faq-item p-4" style={{ backgroundColor: props.itemBackground }}>
...
function ContentBlock(props: any) {
  return (
    <section className="content-block py-16 text-center" style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto">
        <h2 style={{ color: props.titleColor }}>{props.title}</h2>
...
function FooterBlock(props: any) {
  return (
    <footer className="footer-block py-12" style={{ backgroundColor: props.backgroundColor }}>
      <div className="container mx-auto">
...
function ECommerceBlock(props: any) {
  return <div>E-Commerce Block (placeholder)</div>;
}

function GalleryBlock(props: any) {
  return <div>Gallery Block (placeholder)</div>;
}

function RatingBlock(props: any) {
