...
let CreateRoleDto = (() => {
    ...
    return class CreateRoleDto {
        static {
            ...
            _name_decorators = [(0, swagger_1.ApiProperty)({ description: 'Unique role name (e.g., "admin", "editor")', example: 'custom_role' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(100)];
            _displayName_decorators = [(0, swagger_1.ApiProperty)({ description: 'Display name for the role', example: 'Custom Role' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(100)];
            _description_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Role description' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
            _permissions_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Array of permission IDs', type: [String] }), (0, class_validator_1.IsArray)(), (0, class_validator_1.IsString)({ each: true }), (0, class_validator_1.IsOptional)()];
            _isActive_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'Is role active', default: true }), (0, class_validator_1.IsBoolean)(), (0, class_validator_1.IsOptional)()];
        ...
        permissions = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _permissions_initializers, void 0));
