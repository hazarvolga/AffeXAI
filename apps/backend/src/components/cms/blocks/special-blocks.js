...
const SpecialAccordionFaq = ({ props }) => {
    ...
    return (<container_component_1.ContainerComponent id="special-accordion-container" padding="xl" background="none" className="py-16">
      <text_component_1.TextComponent id="special-accordion-title" content={title} variant="heading2" className="text-center mb-12"/>
...
const SpecialCountdownTimer = () => {
    // In a real implementation, this would be a dynamic countdown
    return (<container_component_1.ContainerComponent id="special-countdown-container" padding="xl" background="primary" className="text-center text-white py-16 rounded-lg">
      <text_component_1.TextComponent id="special-countdown-title" content="Limited Time Offer" variant="heading2" className="mb-4"/>
      <text_component_1.TextComponent id="special-countdown-subtitle" content="Special discount ends in:" variant="body" className="mb-8 text-white/80"/>
