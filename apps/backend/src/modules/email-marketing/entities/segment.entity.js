...
let Segment = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('segments')];
    ...
    var Segment = class extends _classSuper {
        ...
        static {
            ...
            _criteria_decorators = [(0, typeorm_1.Column)({ nullable: true })];
            _openRate_decorators = [(0, typeorm_1.Column)({ type: 'decimal', precision: 5, scale: 2, default: 0 })];
            _clickRate_decorators = [(0, typeorm_1.Column)({ type: 'decimal', precision: 5, scale: 2, default: 0 })];
        ...
        subscriberCount = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _subscriberCount_initializers, void 0));
        criteria = (__runInitializers(this, _subscriberCount_extraInitializers), __runInitializers(this, _criteria_initializers, void 0));
