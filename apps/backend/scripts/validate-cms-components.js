...
async function validateComponents() {
    ...
    const componentsDir = path_1.default.join(__dirname, '../src/components/cms');
    ...
    for (const component of expectedComponents) {
        const componentPath = path_1.default.join(componentsDir, component);
    ...
    for (const doc of docs) {
        const docPath = path_1.default.join(__dirname, '../', doc);
...
//# sourceMappingURL=validate-cms-components.js.map