...
import { Role, permissions as allPermissions } from "@/lib/roles-data";
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Input id="role-name" defaultValue={role?.name} placeholder="Örn: Pazarlama Uzmanı"/>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="role-description">Açıklama</Label>
                        <Textarea id="role-description" defaultValue={role?.description} placeholder="Bu rolün amacını ve yetkilerini kısaca açıklayın."/>
                    </div>
                </CardContent>
            </Card>
