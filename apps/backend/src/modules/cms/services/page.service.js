...
let PageService = (() => {
    ...
    var PageService = class {
        ...
        static {
            ...
            PageService = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        pageRepository;
        eventBusService;
        constructor(pageRepository, eventBusService) {
        ...
        async findOne(id) {
            ...
            if (page && (!page.components || page.components.length === 0)) {
                page.components = await this.pageRepository.manager
                    .createQueryBuilder(component_entity_1.Component, 'component')
        ...
        async publish(id) {
            ...
            page.status = shared_types_1.PageStatus.PUBLISHED;
            page.publishedAt = new Date();
            const publishedPage = await this.pageRepository.save(page);
            // Publish platform event
            await this.eventBusService.publishPagePublished(publishedPage.id, publishedPage.slug, 'system');
        ...
        async unpublish(id) {
            ...
            page.status = shared_types_1.PageStatus.DRAFT;
            page.publishedAt = null;
            return this.pageRepository.save(page);
        }
    };
    return PageService = _classThis;
})();
