...
exports.SecurityAlertEmail = void 0;
...
const SecurityAlertEmail = ({ userName = 'Kullanıcı', alertDetails = {
    time: new Date().toLocaleString('tr-TR'),
    ipAddress: '192.168.1.100',
    location: 'Ankara, Türkiye (Tahmini)'
}, passwordResetLink = `${baseUrl}/portal/profile`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={heading}>Güvenlik Uyarısı</components_1.Heading>
            ...
            <components_1.Section style={detailsSection}>
                <components_1.Text style={detailText}><strong>Zaman:</strong> {alertDetails.time}</components_1.Text>
                <components_1.Text style={detailText}><strong>IP Adresi:</strong> {alertDetails.ipAddress}</components_1.Text>
                <components_1.Text style={detailText}><strong>Tahmini Konum:</strong> {alertDetails.location}</components_1.Text>
            </components_1.Section>
            ...
            <components_1.Section style={buttonContainer}>
              <components_1.Button style={button} href={passwordResetLink}>
                Parolamı Değiştir
              </components_1.Button>
            </components_1.Section>
          </components_1.Section>
...
exports.SecurityAlertEmail = SecurityAlertEmail;
exports.default = exports.SecurityAlertEmail;
const main = {
