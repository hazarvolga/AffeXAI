...
const ThankYouEmail = ({ userName = "Ahmet", thankYouFor = "yeni siparişiniz", message = "Aluplan Digital ailesini tercih ettiğiniz için mutluluk duyuyoruz. Siparişiniz en kısa sürede işleme alınacaktır.", ctaText = "Sipariş Detaylarını Gör", ctaLink = `${baseUrl}/portal/orders/AL-12345-TR`, siteSettings, }) => {
      ...
      <components_1.Body style={main}>
        <components_1.Container style={container}>
          ...
          <components_1.Section style={content}>
            <components_1.Heading style={heading}>Teşekkür Ederiz!</components_1.Heading>
            ...
            {ctaText && ctaLink && (<components_1.Section style={buttonContainer}>
...
exports.default = exports.ThankYouEmail;
const main = {
