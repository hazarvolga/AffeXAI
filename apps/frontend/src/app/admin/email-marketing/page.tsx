...
import { EmailValidator } from '@/components/email-marketing/email-validator';
...
type ActiveSection = 'subscribers' | 'campaigns' | 'groups' | 'segments' | 'templates' | 'automations' | null;
...
export default function EmailMarketingDashboardPage() {
  ...
  const sections = {
    subscribers: {
        ...
        actions: [
            { href: '/admin/email-marketing/subscribers/import', label: 'Toplu İçe Aktar', icon: FileUp },
            { href: '/admin/email-marketing/subscribers', label: 'Aboneleri Yönet', icon: Users, variant: 'default' as const },
        ],
    },
    campaigns: {
        title: 'Kampanyalar',
        ...
        actions: [
            { href: '/admin/email-marketing/campaigns/new', label: 'Yeni Kampanya Oluştur', icon: PlusCircle, variant: 'default' as const },
            { href: '/admin/email-marketing/campaigns', label: 'Kampanyaları Yönet', icon: Send, variant: 'default' as const },
        ],
    },
    groups: {
        title: 'Gruplar',
        ...
        actions: [
            { href: '/admin/email-marketing/groups/new', label: 'Yeni Grup Oluştur', icon: PlusCircle, variant: 'default' as const },
            { href: '/admin/email-marketing/groups', label: 'Grupları Yönet', icon: Folder, variant: 'default' as const },
        ],
    },
    segments: {
        title: 'Segmentler',
        ...
        actions: [
            { href: '/admin/email-marketing/segments/new', label: 'Yeni Segment Oluştur', icon: PlusCircle, variant: 'default' as const },
            { href: '/admin/email-marketing/segments', label: 'Segmentleri Yönet', icon: Filter, variant: 'default' as const },
        ],
    },
    templates: {
        title: 'Şablonlar',
        ...
        actions: [
            { href: '/admin/email-marketing/templates/new', label: 'Yeni Şablon Oluştur', icon: PlusCircle, variant: 'default' as const },
            { href: '/admin/email-marketing/templates', label: 'Şablonları Yönet', icon: LayoutTemplate, variant: 'default' as const },
        ],
    },
    automations: {
        title: 'Otomasyon',
        description: 'Otomatik e-posta iş akışları oluşturun ve yönetin.',
        icon: Zap,
        stat: 'Yakında',
        content: <div className="text-center py-8 text-muted-foreground">Otomasyon özelliği yakında kullanıma sunulacak.</div>,
        actions: [
            { href: '/admin/email-marketing/automations', label: 'Otomasyonları Yönet', icon: Zap, variant: 'default' as const },
        ],
    }
  };
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/admin/email-marketing/analytics">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <Button asChild>
              <Link href="/admin/email-marketing/validation">
                Check IP Reputation
              </Link>
            </Button>
          </CardContent>
      ...
      {/* Email Validator Dialog */}
      <Dialog open={isValidatorOpen} onOpenChange={setIsValidatorOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Email Validator</DialogTitle>
            <DialogDescription>
              Comprehensive email validation with 8-layer verification
            </DialogDescription>
          </DialogHeader>
          <EmailValidator />
        </DialogContent>
