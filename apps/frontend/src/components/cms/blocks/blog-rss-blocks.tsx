      ...
      >
        ...
        <div className="p-8">
          ...
          <TextComponent 
            ...
            content={excerpt}
            variant={excerptVariant}
            align={excerptAlign}
            color={excerptColor}
            weight={excerptWeight}
          ...
          <div className="flex items-center">
            ...
            <TextComponent 
              ...
              content={authorName}
              variant={authorNameVariant}
              align={authorNameAlign}
              color={authorNameColor}
              weight={authorNameWeight}
              className="font-medium" 
            />
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <TextComponent 
              ...
              content={authorTitle}
              variant={authorTitleVariant}
              align={authorTitleAlign}
              color={authorTitleColor}
              weight={authorTitleWeight}
            ...
            <TextComponent 
              ...
              align={authorBioAlign}
              color={authorBioColor}
              weight={authorBioWeight}
