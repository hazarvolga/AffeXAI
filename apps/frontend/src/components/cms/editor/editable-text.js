...
const EditableText = ({ value, onChange, className = '', placeholder = 'Click to edit...', tagName: Tag = 'span', }) => {
    ...
    return (<Tag ref={elementRef} contentEditable suppressContentEditableWarning className={`outline-none focus:outline focus:outline-blue-300 ${className} ${!localValue && !isEditing ? 'text-gray-400 italic' : ''}`} onFocus={handleFocus} onBlur={handleBlur} onInput={handleInput} onKeyDown={handleKeyDown}>
